...
in this project, I've built from the concept learnt during the SQL-INTRODUCTION Project. I've learnt working with permissions, joins and constraints.
...
103-rating_genres.sql: MySQL script that lists all genres in the database hbtn_0d_tvshows_scending rating.
